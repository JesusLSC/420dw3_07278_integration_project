...
<head>
    ...
    <script type="text/javascript">
        ...
        const API_USER_URL = "<?= WEB_ROOT_DIR . "api/UserDto" ?>";
...
<header id="header" class="header">
    <?php
    include PRJ_FRAGMENTS_DIR .  DIRECTORY_SEPARATOR .  "standard.page.header.php";
    ?>
</header>
<main id="main">
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-12 col-md-4 row justify-content-center">
                <select id="user-selector" class="">
                    ...
                    <?php
                    foreach ($all_user_instances as $instance) {
...
<footer>
    <?php
    include PRJ_FRAGMENTS_DIR .  DIRECTORY_SEPARATOR .  "standard.page.footer.php";
    ?>
</footer>
</body>
</html>
