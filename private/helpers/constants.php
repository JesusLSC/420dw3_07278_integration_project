 ...
 * @const
 */
const WEB_ROOT_DIR = WEB_DIRECTORY_SEPARATOR . PRJ_ROOT_DIRNAME . WEB_DIRECTORY_SEPARATOR; // REQUEST_HOSTNAME . WEB_DIRECTORY_SEPARATOR . "420DW3_07278_integration_project" . WEB_DIRECTORY_SEPARATOR;
